        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-white display-4" href="https://mobirise.com"><span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>
                    ...
                    <a class="nav-link link text-white dropdown-toggle display-4" href="https://mobirise.com" data-toggle="dropdown-submenu" aria-expanded="false"><span class="mbri-bulleted-list mbr-iconfont mbr-iconfont-btn"></span>
                        ...
                        Episodes</a><div class="dropdown-menu"><a class="text-white dropdown-item display-4" href="https://mobirise.com">Episode 1</a></div>
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">Lorem Ipsum
<div><br></div></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Maecenas sit amet magna eu eros vulputate mattis. Donec vitae tristique lacus. Donec arcu neque, auctor sed ligula nec, elementum dapibus dolor...</p>
                    </div>
...
<div><br></div></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Maecenas sit amet magna eu eros vulputate mattis. Donec vitae tristique lacus...</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="https://mobirise.co" class="btn btn-secondary-outline display-4">
                            Lire Plus</a></div>
                </div>
...
<div><br></div></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Maecenas sit amet magna eu eros vulputate mattis. Donec vitae tristique lacus. Donec arcu neque, auctor sed ligula nec...</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="https://mobirise.co" class="btn btn-secondary-outline display-4">
                            Lire Plus</a></div>
                </div>
